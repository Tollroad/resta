  ...
  return (
    <>
     <div className="w-full h-fit bg-Donate text-white">
        <div className="w-[900px] h-full flex  flex-col items-center text-center justify-center mx-auto">
      ...
      <div className='w-full h-fit mt-6 mb-6'>
          <div className='w-[450px] h-fit flex justify-center items-center mx-auto border-black border-2 flex-col text-center p-2 rounded-lg'>
                <div className='hover:bg-black hover:text-white cursor-pointer hover:duration-300 rounded-lg text-white border-red-600 w-96 p-2 text-2xl font-bold my-3 bg-[#eb5757]'>
                    <h1>Donate 5$</h1>
                </div>
                <div className='hover:bg-black hover:text-white cursor-pointer hover:duration-300 rounded-lg text-white border-red-600 w-96 p-2 text-2xl font-bold my-3 bg-[#eb5757]'>
                    <h1>Donate 10$</h1>
